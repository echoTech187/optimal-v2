    ...
    return (
        <div className="dark:bg-gray-900 ">
            <section className="flex flex-col items-center w-full max-w-[1300px] mx-auto px-4 2xl:px-0" id="article">
                ...
                <button className="w-fit rounded-full dark:bg-gray-100 text-black/80 font-stretch-extra-condensed hover:text-blue-400 tracking-wide cursor-pointer transition ease-in-out duration-300 my-12 border border-gray-500 hover:border-blue-400 py-3 px-6 text-sm">Lihat Semua Artikel</button>
            </section>
        </div>
    );
}