                    ...
                    <div className="flex max-md:flex-col w-full h-full gap-4">
                        ...
                        <div className="relative w-full md:w-1/2 flex flex-col gap-4 my-4 ">
                            ...
                            <ol className="list-disc max-md:text-sm md:text-base xl:text-lg ml-8 mb-3 flex flex-col justify-start gap-2">
                                <li className="relative  before:absolute before:-left-8 before:z-0 before:content-['✓'] before:text-sm before:py-0.5 before:text-center before:text-black/90 before:bg-yellow-300 before:rounded-full before:m-1 before:max-md:w-5 before:max-md:h-5 before:w-6 before:h-6 before:max-md:text-xs marker:text-blue-500  marker:font-bold marker:content-[' '] marker:z-1">Mendapatkan pembelajaran langsung bersama Dosen berpengalaman, meliputi pemaparan materi dan pembahasan soal.</li>
                                <li className="relative  before:absolute before:-left-8 before:z-0 before:content-['✓'] before:text-sm before:py-0.5 before:text-center before:text-black/90 before:bg-yellow-300 before:rounded-full before:m-1 before:max-md:w-5 before:max-md:h-5 before:w-6 before:h-6 before:max-md:text-xs marker:text-blue-500  marker:font-bold marker:content-[' '] marker:z-1">Setiap pertemuan dilengkapi rekaman dan materi pembelajaran, yang dapat diakses kembali untuk memperkuat pemahaman.</li>
                                <li className="relative  before:absolute before:-left-8 before:z-0 before:content-['✓'] before:text-sm before:py-0.5 before:text-center before:text-black/90 before:bg-yellow-300 before:rounded-full before:m-1 before:max-md:w-5 before:max-md:h-5 before:w-6 before:h-6 before:max-md:text-xs marker:text-blue-500  marker:font-bold marker:content-[' '] marker:z-1">Latihan soal disusun sesuai blueprint resmi, membuatnya lebih relevan, tepat sasaran, dan mendukung kesiapan menghadapi UKOM.</li>
                                <li className="relative  before:absolute before:-left-8 before:z-0 before:content-['✓'] before:text-sm before:py-0.5 before:text-center before:text-black/90 before:bg-yellow-300 before:rounded-full before:m-1 before:max-md:w-5 before:max-md:h-5 before:w-6 before:h-6 before:max-md:text-xs marker:text-blue-500  marker:font-bold marker:content-[' '] marker:z-1">Peserta akan dibekali strategi praktis untuk menjawab soal secara cepat dan efektif, agar waktu ujian dapat dimanfaatkan secara optimal.</li>
                                <li className="relative  before:absolute before:-left-8 before:z-0 before:content-['✓'] before:text-sm before:py-0.5 before:text-center before:text-black/90 before:bg-yellow-300 before:rounded-full before:m-1 before:max-md:w-5 before:max-md:h-5 before:w-6 before:h-6 before:max-md:text-xs marker:text-blue-500  marker:font-bold marker:content-[' '] marker:z-1">Penyampaian materi dilakukan secara jelas dan mudah dipahami, memudahkan peserta dalam menguasai materi yang diberikan.</li>
                            </ol>
