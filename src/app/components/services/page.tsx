                ...
                <div className="max-w-[1300px] mx-auto py-8 px-4">
                    <div className="flex max-md:flex-col w-full h-full gap-4">
                        ...
                        <div className="relative w-full md:w-1/2 flex flex-col gap-4 my-4 ">
                            ...
                            <button type="button" className="flex w-fit items-center bg-[#FFB800] hover:bg-[#FFB800] text-black max-md:text-xs max-md:px-4 max-md:py-2 py-3 px-6 rounded-full font-semibold tracking-wide cursor-pointer transition ease-in-out duration-300" onClick={() => handleClick('https://bimbel.optimaluntuknegri.id')}>Pelajari Lebih Lanjut <Icon icon="material-symbols:arrow-right-alt-rounded" width={24} height={24} /></button>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-[1300px] mx-auto py-8 px-4">
                    <div className="flex max-md:flex-col w-full h-full gap-4">
                        ...
                        <div className="relative w-full md:w-1/2 flex flex-col gap-4 my-4 ">
                            ...
                            <button type="button" className="flex w-fit items-center bg-[#FFB800] hover:bg-[#FFB800] text-black max-md:text-xs max-md:px-4 max-md:py-2 py-3 px-6 rounded-full font-semibold tracking-wide cursor-pointer transition ease-in-out duration-300" onClick={() => handleClick('https://penerbit.optimaluntuknegri.id')}>Pelajari Lebih Lanjut <Icon icon="material-symbols:arrow-right-alt-rounded" width={24} height={24} /></button>
                        </div>
                    </div>
                </div>
            </section>
